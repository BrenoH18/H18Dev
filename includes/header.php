<?php
    ...
    function navbar($user_data, $empresa, $id){
        if($user_data['permissao'] == 'desenvolvedor'){
            ...
            header("Location: ../templates/index.php?id=$id");
        }
    };
?>
...
<html lang="pt-br">
    ...
    <body>
        <header>
            <div class="header">
                <a href="../templates/index.php?id=$id" class="logo">Olá <strong><?php echo $user_data['nome'].' '.$user_data['sobrenome'];?></strong>, seja bem vindo!</a>
